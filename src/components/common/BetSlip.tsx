          ...
          <div className="flex flex-col gap-2 mt-6 p-2" key={i}>
            ...
            <div
              className={twMerge(
                ...
                item.selectedBet === "back" ? "bg-blue-300" : " bg-pink-300"
              )}
            >
              ...
              <div className="flex gap-2 text-white">
                <PrimaryButton label="Place Bet" type="button" />
                <SecondaryButton
                  label="Remove Bet"
                  type="button"
                  onClick={() => {
                    const filterItem = selectedBetData.filter(
                      (a: BetSlipType) => a.selectedTeam !== item.selectedTeam
                    );
